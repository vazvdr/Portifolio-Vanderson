    ...
    const projects = [
        {
            ...
            techs: ["react", "tailwindcss", "java", "spring", "swagger", "junit", "postgresql", "redis", "mongodb", "rabbitmq", "docker", "kubernetes", "githubactions"],
        },
        {
            title: "Praia Cheia",
            image: PraiaCheia,
        ...
        },
        {
            ...
            techs: ["react", "tailwindcss", "axios", "cypress", "spring", "swagger", "junit", "postgresql", "docker", "githubactions"],
        },
        {
